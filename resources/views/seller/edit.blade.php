...
<div class="container d-flex justify-content-center align-items-center">
  <form class="bg-grey border border-dark p-5 my-3 rounded" action="{{ route('store') }} " method="post" enctype="multipart/form-data">
      @csrf
      @method('POST')
    ...
    <button type="submit" class="btn btn-outline-dark float-right"><i class="fas fa-pen-square"> Perbarui</i></button>
  </form>
